...
export function LiveFeed({ className, defaultCategory = "all" }: LiveFeedProps) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        "bg-white/50 dark:bg-neutral-900/50 backdrop-blur-xl rounded-[2.5rem] p-6 sm:p-8",
        "border border-white/20 dark:border-white/10 shadow-2xl shadow-black/5 flex flex-col",
        className,
      )}
    >
      {/* Header */}
